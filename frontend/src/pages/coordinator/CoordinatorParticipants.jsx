...
const CoordinatorParticipants = () => {
  ...
  const saveParticipant = async () => {
    if (participants.length >= 5 && !form.id) {
    ...
    if (form.id) {
      ...
      await axios.post(
        `${API}/groups/${selectedGroup}/participants`,
        body,
        { headers: { Authorization: "Bearer " + token } }
      );
    }
        ...
        <div className="row">
          ...
          <div className="col-md-2 sidebar p-0">
            <ul className="nav flex-column mt-4">
              ...
              <li><Link className="nav-link active" to="/participants">Participants</Link></li>
          ...
          <div className="col-md-10 main-content">
            ...
            <div className="d-flex justify-content-between mb-4">
              <h5 className="fw-bold">Participants Management</h5>
            ...
            <select className="form-control mb-2 select-sm"
              value={selectedEvent}
            ...
            <select className="form-control mb-3 select-sm"
              value={selectedGroup}
                ...
                <tbody>
                  {participants.map(p => (
                    <tr key={p._id}>
                      ...
                      <td>
                        <button className="btn btn-warning btn-icon me-2"
            ...
            <div className="modal-content p-3">
              ...
              <div className="text-end">
                ...
                <button className="btn btn-sm btn-success"
                  onClick={saveParticipant}>Save</button>
              </div>
